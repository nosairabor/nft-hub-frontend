...
const SideBar = ({isOpen, setIsOpen}) => {
    return (
        <div className={` ${isOpen ? ' translate-x-0  ' : ' -translate-x-full '} md:-mx-[100px] lg:-mx-[250px] xl:px-0 xl:hidden pt-5  w-screen transform transition-transform duration-500 z-50 fixed overflow-y-auto h-screen bg-white `}>
